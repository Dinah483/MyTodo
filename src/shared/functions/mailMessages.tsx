...
export const MAIL_SCORECARD_DRAFT_SUBMITTED_MANAGER = (
  ...
  const BODY = [
    ...
    "",
    "Visit PMS System: https://lots.unicomms.app for more.",
    "",
    "Sincerely,",
    name + " - PMS System",
  ];
...
export const MAIL_PROJECT_TASK_ADDED = (
  ...
  const MY_BODY = [
    `${greeting}`,
    "",
    (type === "project") ? `You were added to a project (${name}) by ${employeeName}` : "",
...
export const MAIL_EMAIL = "no-reply@lotsinsghts.com";
